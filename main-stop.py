...
def main():
    ...
    # Disable autopilot mode for the player vehicle and stop the vehicle
    player.set_autopilot(False)
#    print("Player vehicle is now in manual control mode.")
#    player.apply_control(carla.VehicleControl(throttle=0.0, steer=0.0))
#    print("Player vehicle has been stopped.")
